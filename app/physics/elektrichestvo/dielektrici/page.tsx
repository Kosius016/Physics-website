    ...
    <TeacherModeProvider>
      <main className="mx-auto max-w-3xl px-5 pb-24">
        ...
        <Section id="polarization" n="§2" title="Поляризация отвътре">
          ...
          <p>
            Макроскопичната поляризация <RichText text="$\vec P$" /> е диполният момент на
            единица обем. За прост линеен и изотропен диелектрик:
          </p>
          <div className="mt-4">
            <Formula
              latex={String.raw`\vec P=\varepsilon_0\chi_e\vec E,\qquad
              \varepsilon_r=1+\chi_e`}
            />
          </div>
          <p className="mt-4">
            При еднородна поляризация в обема положителните и отрицателните краища на
            съседните диполи се компенсират. Остават свързани заряди по граничните
            повърхности.
          </p>
          <TeacherNote>
        ...
        <Section id="field" n="§3" title="Свързаните заряди намаляват полето">
          <PredictionQuestion
            ...
            options={[
              { text: "Отдясно наляво, срещу полето на плочите", correct: true },
              { text: "Отляво надясно, по посока на полето на плочите", correct: false },
              { text: "Перпендикулярно на полето на плочите", correct: false },
            ]}
            explanation="До положителната плоча се появява свързан отрицателен заряд, а до отрицателната плоча свързан положителен. Полето им сочи от свързания плюс към свързания минус и намалява първоначалното поле."
          />
          <p className="mt-5">
        ...
        <Section id="constant" n="§4" title="Ключовият въпрос: заряд или потенциал">
          ...
          <PredictionQuestion
            ...
            explanation="Батерията фиксира $V$, а разстоянието $d$ не се променя. За идеален плосък кондензатор $E=V/d$. Батерията внася допълнителен свободен заряд, който компенсира намаляването от поляризацията."
          />
