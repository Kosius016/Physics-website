    ...
    <main className="mx-auto max-w-3xl px-5 pb-24">
      ...
      <Section id="earnshaw" n="§4" title="Защо неподвижни заряди не могат да задържат заряд">
        <QuestionCard code="T7" title="Теорема на Ърншоу">
          ...
          <Solution
            hint={
              <RichText text="Запишете какво изискват устойчивостта и равновесието от вторите производни на $V$, после сравнете изискването с това, което дава законът на Гаус за същите производни." />
            }
          >
            ...
            <SolutionPart label="b" title="Условието за устойчивост">
              <p>
                Потенциалната енергия на заряда е <RichText text="$U=qV$" />. Развиваме я около{" "}
                <RichText text={String.raw`$\vec r_0$`} />. Първите производни отпадат по подточка
                а), затова водещият член е квадратичен:
              </p>
              <Formula
                latex={String.raw`U(\vec r_0+\vec\delta)-U(\vec r_0)
                =\frac q2\left(
                \frac{\partial^2V}{\partial x^2}\delta_x^2
                +\frac{\partial^2V}{\partial y^2}\delta_y^2
                +\frac{\partial^2V}{\partial z^2}\delta_z^2\right)+\cdots`}
              />
              <p>
                Осите са избрани по главните оси на матрицата от вторите производни, за да няма
                смесени членове. Равновесието е устойчиво само ако енергията расте при отместване{" "}
                <strong>във всяка</strong> посока. За <RichText text="$q>0$" /> това изисква и
                трите числа едновременно:
              </p>
              <Formula
            ...
            <SolutionPart label="d" title="Противоречието">
              <p>
                ...
                положителни числа не могат да имат сбор нула, затова поне едно от тях е отрицателно
                или нула.
              </p>
              <p>
                Ако някое е отрицателно, по тази ос енергията <strong>намалява</strong> и зарядът
                си тръгва при най-малкото побутване. Остава изроденият случай, в който и трите са
                нула: тогава квадратичният член изчезва изцяло и по нито една посока енергията не
                расте, тоест минимум пак няма. За <RichText text="$q<0$" /> всички знаци се
                обръщат и разсъждението е дословно същото.
              </p>
              <FigurePanel
