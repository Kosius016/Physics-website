...
export const metadata = {
  title: "Контролно по електростатика с подробни решения · SingularityLab",
  description:
          ...
          <FigurePanel
            ...
            caption={
              <>
                ...
                Ъгълът <RichText text={String.raw`$\theta$`} /> се брои от тази ос. Фонът е самият
                потенциал: топло там, където <RichText text="$V<0$" />, студено там, където{" "}
                <RichText text="$V>0$" />, и безцветно по повърхността на сферата и по
                екваториалната равнина, където <RichText text="$V=0$" />. Жълтите линии са
                силовите, белите пунктирани са еквипотенциалите; двете семейства се пресичат под
                прав ъгъл навсякъде. Индуцираният заряд нарочно липсва: той е търсеното в подточки
                в) и г).
              </>
            }
          >
