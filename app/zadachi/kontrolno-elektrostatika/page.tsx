  ...
  return (
    <main className="mx-auto max-w-3xl px-5 pb-24">
      ...
      <Section id="dielectric" n="§3" title="Диелектрик между плочите">
        <QuestionCard code="T5" title="Поляризация и свързан заряд">
          <ProblemStatement>
            <p>
              Диелектрик се внася в кондензатор. Обяснете поотделно какво се случва с неполярните
              молекули и с молекулите, които имат постоянен диполен момент. Откъде се появява
              некомпенсиран заряд по повърхностите на диелектрика и защо полето вътре в него
              отслабва? Как се дефинира <RichText text={String.raw`$\varepsilon_r$`} /> чрез
              капацитета?
            </p>
          </ProblemStatement>
          ...
          >
            ...
            <SolutionPart label="b" title="Свързаният заряд">
              <p>
                Макроскопичното подреждане се описва с поляризацията{" "}
                <RichText text={String.raw`$\vec P$`} />, тоест диполен момент на единица обем. В
                равномерно поляризираната вътрешност зарядите на съседните диполи се компенсират,
                но по границата остава некомпенсиран повърхностен заряд:
              </p>
              <Formula latex={String.raw`\sigma_b=\vec P\cdot\hat n`} />
              <p>
                В нееднороден диелектрик може да има и обемен свързан заряд{" "}
                <RichText text={String.raw`$\rho_b=-\nabla\cdot\vec P$`} />.
              </p>
            </SolutionPart>

            <SolutionPart label="c" title="Защо полето отслабва">
              <p>
                Полето на свързаните заряди е противоположно на външното, защото положителният
                свързан заряд сяда до отрицателната плоча и обратно. Резултантното поле в
                материала намалява.
              </p>
            </SolutionPart>

            <SolutionPart label="d" title="Определение на проницаемостта">
      ...
      <Section id="earnshaw" n="§4" title="Защо неподвижни заряди не могат да задържат заряд">
        <QuestionCard code="T7" title="Теорема на Ърншоу">
          ...
          >
            <SolutionPart label="a" title="Уравнението на Лаплас">
              <p>
                В празна област <RichText text={String.raw`$\rho=0$`} />. От закона на Гаус и{" "}
                <RichText text={String.raw`$\vec E=-\nabla V$`} /> следва
              </p>
              <Formula latex={String.raw`\nabla\cdot\vec E=0\quad\Longrightarrow\quad \boxed{\nabla^2V=0}`} />
            </SolutionPart>

            <SolutionPart label="b" title="Свойството на средната стойност">
              <p>
                Решенията на уравнението на Лаплас имат свойството, че стойността в центъра на
                малка сфера е средната стойност по нейната повърхност. Затова потенциалът не може
            ...
            <SolutionPart label="c" title="Изводът за равновесието">
              <p>
                За положителен пробен заряд устойчивото равновесие би изисквало локален минимум на{" "}
                <RichText text="$V$" />, а за отрицателен - локален максимум. И двете са невъзможни
                в празна тримерна област.
              </p>
              <ResultBox>
                Заряд не може да бъде задържан устойчиво само от неподвижни електрични заряди. Това
                е теоремата на Ърншоу. Реалните капани заобикалят условията ѝ: използват променливи
                във времето полета, диамагнетизъм или обратна връзка.
              </ResultBox>
            </SolutionPart>
          </Solution>
        </QuestionCard>
