          ...
          <FigurePanel
            ...
            caption={
              <>
                ...
                екваториалната равнина, където <RichText text="$V=0$" />. Белите линии са силовите,
                жълтите пунктирани са еквипотенциалите; двете семейства се пресичат под прав ъгъл
                навсякъде. Индуцираният заряд нарочно липсва: той е търсеното в подточки в) и г).
              </>
            }
          >
            <SphereInFieldFigure />
