          ...
          <FigurePanel
            ...
            caption={
              <>
                ...
                Ъгълът <RichText text={String.raw`$\theta$`} /> се брои от тази ос. Линиите не са
                нарисувани на око: те са нивата на{" "}
                <RichText text={String.raw`$\psi=\left(\frac{r^2}2+\frac{R^3}r\right)\sin^2\theta$`} />
                , функцията на тока на сбора „еднородно поле плюс дипол в центъра“. Точно същият
                похват описва и обтичането на сфера от флуид, само че там диполният член влиза с
                обратен знак: при флуида линиите се изтласкват навън, а тук се притеглят към
                сферата и завършват перпендикулярно на нея, защото има къде да свършат - върху
                индуцирания заряд. Линиите, минали на повече от{" "}
