  ...
  return (
    <main className="mx-auto max-w-3xl px-5 pb-24">
      <header className="pt-11 pb-3">
        ...
        >
          <Link href="/materiali?subject=math&level=university&type=zadachi" className="transition-colors hover:text-minus">
            Задачи
          </Link>
      ...
      <div className="mt-12 flex flex-wrap items-center justify-between gap-3 border-t-2 border-ink pt-5">
        <Link href="/materiali?subject=math&level=university&type=zadachi" className="font-semibold text-minus hover:underline">
          ← Всички problem sets
        </Link>
