...
const physics11: CourseSection[] = [
  {
    /**
     * Редът следва учебника за профилирана подготовка, тема 1 „Кинематика“
     * (уроци 2-12). Номерацията тук е последователна в рамките на раздела.
     */
    ...
    lessons: [
      ...
      { number: "1.3", title: "Скорост и ускорение" },
      { number: "1.4", title: "Праволинейно движение (преговор и обобщение)" },
      { number: "1.5", title: "Праволинейно равнопроменливо движение (задачи)" },
      { number: "1.6", title: "Графики на праволинейно движение (задачи)" },
      {
        number: "1.7",
        title: "Движение на тяло, хвърлено под ъгъл спрямо хоризонта",
        href: "/physics/kinematika/dvizhenie-pod-agal",
        publishedAt: "2026-07-12",
        draft: true,
      },
      { number: "1.8", title: "Движение по парабола (задачи)" },
      { number: "1.9", title: "Тангенциално и нормално ускорение" },
      { number: "1.10", title: "Движение по окръжност" },
      { number: "1.11", title: "Движение по окръжност (задачи)" },
    ],
  },
  {
