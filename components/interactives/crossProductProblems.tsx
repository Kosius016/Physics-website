...
export const crossProductProblems: GuidedProblemData[] = [
  ...
  },
  {
    ...
    additionQuestion: {
      ...
      explanation:
        "Точно както знакът на детерминантата в равнината различаваше огледалното обръщане, тук той различава дясна от лява тройка. Геометричният обем е модулът, но знакът носи истинска информация.",
    },
    hints: [
    ...
    teacherNotes: [
      "Свържете с §7: смесеното произведение е детерминантата на матрицата с трите вектора като колони, тоест пространствената версия на площта от предишния урок.",
  ...
  },
  {
    ...
    additionQuestion: {
      ...
      explanation:
        "Същият критерий, една размерност по-нагоре. В равнината $\\det M=0$ значеше „равнината е смачкана в права“; в пространството значи „пространството е смачкано в равнина“, тоест колоните са зависими.",
    },
    hints: [
